...
if ($usergroups['canbonus'] == 'no' OR $usergroups['canbonus'] != 'yes') {
	stderr( "Sorry...", "You are not allowed to use the bonus system" );
	exit;
}
getpage();
...
$CURUSER[username] you have set the tracker <b>Free Leech !</b> <img src=".$pic_base_url."/smilies/w00t.gif alt=w00t><br><br>Remaining ".safeChar($_GET['norefund'])." points have been contributed towards the next freeleech period automatically!".
...
echo("<table width=80%><tr><td class=colhead align=left colspan=2><h1>Success!</h1></td></tr><tr>".
"<td align=left class=clearalt6><img src=".$pic_base_url."smilies/karma.gif alt=good_karma></td><td align=left class=clearalt6><b>Congratulations! </b>
$CURUSER[username] you have set the tracker <b>Double Up !</b> <img src=".$pic_base_url."/smilies/w00t.gif alt=w00t><br><br>Remaining ".safeChar($_GET['norefund'])." points have been contributed towards the next Double upload period automatically!".
"<br> click to go back to your <a class=altlink href=mybonus.php>Karma Bonus Point</a> page.<br><br>".
"</td></tr></table>");
stdfoot();
} else {
...
echo("<table width=80%><tr><td class=colhead align=left colspan=2><h1>Success!</h1></td></tr><tr>".
"<td align=left class=clearalt6><img src=".$pic_base_url."smilies/karma.gif alt=good_karma></td><td align=left class=clearalt6><b>Congratulations! </b>
$CURUSER[username] you have set the tracker <b>Half Download !</b> <img src=".$pic_base_url."/smilies/w00t.gif alt=w00t><br><br>Remaining ".safeChar($_GET['norefund'])." points have been contributed towards the next Half download period automatically!".
"<br> click to go back to your <a class=altlink href=mybonus.php>Karma Bonus Point</a> page.<br><br>".
"</td></tr></table>");
stdfoot();
} else {
echo("<table width=80%><tr><td class=colhead align=left colspan=2><h1>Success!</h1></td></tr><tr>".
"<td align=left class=clearalt6><img src=".$pic_base_url."smilies/karma.gif alt=good_karma></td><td align=left class=clearalt6><b>Congratulations! </b>
$CURUSER[username] you have set the tracker <b>Half Download !</b> <img src=".$pic_base_url."/smilies/w00t.gif alt=w00t><br>".
"<br> click to go back to your <a class=altlink href=mybonus.php>Karma Bonus Point</a> page.<br><br>".
"</td></tr></table>");
stdfoot();
}
...
echo("<table width=80%><tr><td class=colhead align=left colspan=2><h1>Success!</h1></td></tr><tr>".
"<td align=left class=clearalt6><img src=".$pic_base_url."smilies/karma.gif alt=good_karma></td><td align=left class=clearalt6><b>Congratulations! </b>".
"$CURUSER[username] you have contributed towards making the tracker Half Download ! <img src=".$pic_base_url."/smilies/w00t.gif alt=w00t><br>".
"<br> click to go back to your <a class=altlink href=mybonus.php>Karma Bonus Point</a> page.<br><br>".
"</td></tr></table>");
stdfoot();
die;
...
$bonuscomment = gmdate("Y-m-d") . " - " .$donation. " Points contributed for doubleupload.\n " .$bonuscomment;
...
$norefund = ($donation + $pointspool) % $points;
sql_query($sql)or sqlerr(__FILE__, __LINE__);
$bonuscomment = gmdate("Y-m-d") . " - " .$donation. " Points contributed for freeleech.\n " .$bonuscomment;
sql_query("UPDATE users SET seedbonus = '$seedbonus', lastchange='" . get_date_time() . "', bonuscomment = '$bonuscomment' WHERE id = '$userid'") or sqlerr(__FILE__, __LINE__);
...
$norefund = ($donation + $pointspool) % $points;
sql_query($sql)or sqlerr(__FILE__, __LINE__);
$bonuscomment = gmdate("Y-m-d") . " - " .$donation. " Points contributed for Halfdownload.\n " .$bonuscomment;
sql_query("UPDATE users SET seedbonus = '$seedbonus', lastchange='" . get_date_time() . "', bonuscomment = '$bonuscomment' WHERE id = '$userid'") or sqlerr(__FILE__, __LINE__);
$sql2 = "UPDATE bonus SET pointspool = '$norefund' WHERE id = '24' LIMIT 1";
sql_query($sql2)or sqlerr(__FILE__, __LINE__);
write_bonus_log($CURUSER["id"], $donation, $type = "halfdownload");
header("Refresh: 0; url=$BASEURL/mybonus.php?halfdown_success=1&norefund=$norefund");
die;

} else {
// add to the pool
$sql = "UPDATE bonus SET pointspool = pointspool + '$donation' WHERE id = '24' LIMIT 1";
sql_query($sql)or sqlerr(__FILE__, __LINE__);
$bonuscomment = gmdate("Y-m-d") . " - " .$donation. " Points contributed for halfdownload.\n " .$bonuscomment;
sql_query("UPDATE users SET seedbonus = '$seedbonus', lastchange='" . get_date_time() . "', bonuscomment = '$bonuscomment' WHERE id = '$userid'") or sqlerr(__FILE__, __LINE__);
write_bonus_log($CURUSER["id"], $donation, $type = "halfdownload");
header("Refresh: 0; url=$BASEURL/mybonus.php?halfdown_success=2");
die;
}
die;
break;
...
stdhead($CURUSER['username'] . "'s Karma Bonus Page");
$sql = "SELECT id,SUM(donation) as total FROM `bonuslog` WHERE `type` = 'freeleech' OR 'doubleupload' OR 'halfdownload' GROUP BY `id` ORDER BY total DESC LIMIT 10;";
$res2 = sql_query($sql);
...
'<li>getting extra invites</li><li>Freeleech contribution - Max 199999 points - button can be seen if you have over 100000 points.</li><li>Double Upload contribution - Max 199999 points - button can be seen if you have over 100000 points.</li><li>Half Download contribution - Max 199999 points - button can be seen if you have over 100000 points.</li><li>Download reset</li><li>giving a gift of karma points to another user</li>'.
