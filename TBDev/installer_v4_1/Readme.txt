/// Installerv4
/// All Credit goes to the original code creators, the code advisors , the advanced members especially to any author for the mods i selected for this . 
...
/// Huge thanks to VOLK, Pinduur, Soft, Basset, Swizzles, Elephant2, KiD for his excellent design skills, MrXp, RikT, Autotron, r33p0phph, Diablo999, Stan, yoob.
...
/// Credit's to pdq/putyn for optimizations .. HTML Validation and improvements in key areas on the installer code - dotblue ... what can i say i love that theme - Your input has been first class.
/// 
/// 
Set Up Instructions :
///
///
////////on-screen steps////////////
Quick notes for installing this Pre-Coded Release By Bigjoos.
...
//////////////////////////////////////////////////////////////////////////////
1. Go to http://localhost/install/index.php or http://yourdomain.org/install/index.php
2. Follow on screen steps
3. Once installed make sure to chmod or delete the install directory
4. Customize to your own taste !!
//////////////////////////////Installerv4 - Pre-Coded Auto Installer By Bigjoos///////////////////