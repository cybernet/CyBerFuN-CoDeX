...
<option value="1"<?php print($blah == 1 ? " selected" : "");?>><?php echo $language['strd'];?></option>
<option value="2"<?php print($blah == 2 ? " selected" : "");?>><?php echo $language['strb'];?></option>
</select>
in
<select name=incldead>
<option value="0"><?php echo $language['stra'];?></option>
<option value="1"<?php print(!isset($_GET["incldead"]) == 1 ? " selected" : "");?>><?php echo $language['str3'];?></option>
<option value="2"<?php print(!isset($_GET["incldead"]) == 2 ? " selected" : "");?>><?php echo $language['str4'];?></option>
<?php
...
<?php
    if ($CURUSER["imagecats"] == "yes") {
        ...
        foreach ($cats as $cat) {
            $catsperrow = 5;
            $catz = ($CURUSER['imagecats'] == 'yes' ? "<img border=0 src=\"pic/caticons/$cat_ico_uri/" . $cat["image"] . "\" title=\"There are " . (0 + $catcount[$cat["id"]]["count"]) . " in this category\"/>" : safeChar($cat['name']));
