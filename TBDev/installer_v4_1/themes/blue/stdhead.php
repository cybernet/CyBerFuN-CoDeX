...
<body <?=($_SERVER["REQUEST_URI"] == "/browse.php" ? "onload=\"auto();\"" : "")?> onload="MM_preloadImages('themes/blue/theme/menu/news-b.png','themes/blue/theme/menu/browse-b.png','themes/blue/theme/menu/req-b.png','themes/blue/theme/menu/upload-b.png','themes/blue/theme/menu/forum-b.png','themes/blue/theme/menu/support-b.png')">
...
<?php
    ...
    if ($CURUSER['donor'] == "yes")
        $icon .= "<img src=\"themes/blue/pic/donor.png\" align=\"baseline\"alt=donor title=donor $icon_style />";
    if ($CURUSER['warned'] == "yes")
        $icon .= "<img src=\"themes/blue/pic/warned.png\" align=\"baseline\"  alt=warned title=warned $icon_style />";
    if ($CURUSER["webseeder"] == "yes")
        $icon .= "<img src=\"themes/blue/pic/webseeder.png\" align=\"baseline\"  alt=webseeder title=webseeder $icon_style/>";
...
<table width="838" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="userbar"><a href="userdetails.php?id=<?=$CURUSER['id']?>"><?=$CURUSER['username']?> </a></b><?=$usrclass?><?=$icon?>&nbsp;&nbsp;<font color="#0A5EB5">Upload:</font>&nbsp;<?=$uped?>&nbsp;&nbsp;<font color="#0A5EB5">Ratio:</font>&nbsp;<font color="#525252"><?=$ratio?></font>&nbsp;&nbsp;<font color="#0A5EB5">Slots:</font>&nbsp;<?=number_format($CURUSER['freeslots'])?>&nbsp;&nbsp;<font color="#0A5EB5">Bonus:</font>&nbsp;<a href="mybonus.php"><?=number_format($CURUSER['seedbonus'], 1)?></a>&nbsp;&nbsp;<font color="#0A5EB5">Invites:</font>&nbsp;<font color="#525252"><a href="invite.php"><?=$invites?></a></font>&nbsp;&nbsp;|&nbsp;&nbsp;<?php
if (!empty($unread))
    $inbox = ($unread == 1 ? "$unread&nbsp;New Message&nbsp;<a href=$BASEURL/messages.php?action=viewmailbox><img height=\"14\" style=border:none alt=inbox title='inbox (New Pm)' src=themes/blue/pic/pn_inboxnew.gif></a>&nbsp;&nbsp;" : "$unread&nbsp;New Messages&nbsp;<a href=$BASEURL/messages.php?action=viewmailbox><img height=\"14\" style=border:none alt=inbox title='inbox (New Pm)' src=themes/blue/pic/pn_inboxnew.gif></a>&nbsp;&nbsp;");
    else
    $inbox = "0&nbsp;New Messages&nbsp;<a href=$BASEURL/messages.php?action=viewmailbox><img height=\"14\" style=border:none alt=inbox title='inbox (No new PMs)' src=themes/blue/pic/pn_inbox.gif></a>&nbsp;&nbsp;";
    echo $inbox;
    ?>&nbsp;&nbsp;<a href="#" onclick="themes();"><img src="themes/blue/pic/theme.png" width="14" height="14" alt=" " title="Change your theme" border="0"/></a>
...
<div id="online_friends" style="display:none;width:120px;z-index:200;position:absolute"></div></td>
  ...
  <tr>
    <td class="maintop"><a href="index.php"><img src="themes/blue/theme/menu/news-a.png" name="Image1" border="0" id="Image1" onmouseover="MM_swapImage('Image1','','themes/blue/theme/menu/news-b.png',1)" onmouseout="MM_swapImgRestore()" /></a><a href="browse.php"><img src="themes/blue/theme/menu/browse-a.png" name="Image2" border="0" id="Image2" onmouseover="MM_swapImage('Image2','','themes/blue/theme/menu/browse-b.png',1)" onmouseout="MM_swapImgRestore()" /></a><a href="requests.php"><img src="themes/blue/theme/menu/req-a.png" name="Image3" border="0" id="Image3" onmouseover="MM_swapImage('Image3','','themes/blue/theme/menu/req-b.png',1)" onmouseout="MM_swapImgRestore()" /></a><? if (get_user_class() >= UC_UPLOADER) {        ?><a href="upload.php"><img src="themes/blue/theme/menu/upload-a.png" border="0" id="Image4" onmouseover="MM_swapImage('Image4','','themes/blue/theme/menu/upload-b.png',1)" onmouseout="MM_swapImgRestore()" /></a><? } ?><a href="forums.php"><img src="themes/blue/theme/menu/forum-a.png" border="0" id="Image5" onmouseover="MM_swapImage('Image5','','themes/blue/theme/menu/forum-b.png',1)" onmouseout="MM_swapImgRestore()" /></a><a href="staff.php"><img src="themes/blue/theme/menu/support-a.png" border="0" id="Image6" onmouseover="MM_swapImage('Image6','','themes/blue/theme/menu/support-b.png',1)" onmouseout="MM_swapImgRestore()" /></a></td>
  </tr>
  <tr>
    <td class="minimenu">&nbsp;&nbsp;&nbsp;&nbsp;<a href=helpdesk.php>Helpdesk</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=faq.php>FAQ</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=rules.php>Rules</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=usercp.php>Profile</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=topten.php>Top10</a>&nbsp;&nbsp;&nbsp;&nbsp;<? if (get_user_class() <= UC_UPLOADER) {        ?><a href=uploadapp.php>Uploader Application</a>&nbsp;&nbsp;&nbsp;&nbsp;<? } ?><a href=getrss.php>Get RSS</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=chat.php>IRC</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=donate.php>Donate</a>&nbsp;&nbsp;&nbsp;&nbsp;Shoutbox:&nbsp;<?php echo "".($CURUSER['show_shout'] === 'no' ? "<a href=shoutbox.php?show_shout=1&show=yes>Show</a>" : "<a href=shoutbox.php?show_shout=1&show=no>Hide</a>").""; ?>&nbsp;&nbsp;&nbsp;|&nbsp;<a href="logout.php" onClick="return log_out()">(Logout)</a>&nbsp;&nbsp;&nbsp;&nbsp;<? if (get_user_class() >= UC_MODERATOR) {        ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="staffpanel.php"><font color="#0A5EB5">Staffpanel</font></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=snews.php><font color="#0A5EB5">Staff-News</font></a><?php } ?><? if (get_user_class() >= UC_CODER) {        ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="core.php"><font color="#0A5EB5">Settings</font></a>
            <?php }
    ?></td>
  </tr>
</table>
