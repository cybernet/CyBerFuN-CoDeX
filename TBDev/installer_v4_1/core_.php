...
$options = array('Freeleech and Doubleup',
    ...
    'Site Karma contributions settings',
    array('Half Title', 'string', 'halftitle', '$halftitle', 'bbcodes allowed.', 'Sitewide Half Download - 3 days!'),
    array('Half Message', 'string', 'halfmessage', '$halfmessage', 'bbcodes allowed.', '[size=2]All torrents marked Half Download - Users Karma contribution![/size]  :w00t:'),   
    array('Freeleech Title', 'string', 'freeleechtitle', '$freeleechtitle', 'bbcodes allowed.', 'Sitewide Free Download - 3 days!'),
    array('Freeleech Message', 'string', 'freeleechmessage', '$freeleechmessage', 'bbcodes allowed.', '[size=2]All torrents marked Free - Users Karma contribution![/size]  :w00t:'),   
    array('Doubleup Title', 'string', 'doubleuptitle', '$doubleuptitle', 'bbcodes allowed.', 'Sitewide Double Upload - 3 days!'),
    array('Doubleup Message', 'string', 'doubleupmessage', '$doubleupmessage', 'bbcodes allowed.', '[size=2]All torrents marked Double Upload - Users Karma contribution![/size]  :w00t:'),    
    'Site wait times ect',
    ...
    'Auto * Users',
    array('Transfer Limit', 'bytes', 'aplimit', '$ap_limit', 'Uploaded amount for promotion', '26214400'),
    ...
    array('Auto invites', 'tf', 'erreport', '$ai', 'Enable auto invites', 'false'),
    ...
    'Auto Cleanup * switches',
    array('Cleanup On-Off', 'tf', 'bcleanup', '$docleanup', 'Auto clean on or off ?', 'true'),
    array('Slow Cleanup On-Off', 'tf', 'bslowcleanup', '$slowcleanup', 'Auto Slow clean on or off ?', 'true'),
    array('Lottery Cleanup On-Off', 'tf', 'blotterycleanup', '$lotteryclean', 'Auto Lottery clean on or off ?', 'true'),
    array('Stage 2 Slow Cleanup On-Off', 'tf', 'bs2slowcleanup', '$s2slowcleanup', 'Auto Stage 2 Slow clean on or off ?', 'true'),
    array('Optimize Db On-Off', 'tf', 'boptimze', '$optimizedb', 'Optimize Db on or off ?', 'true'),
    array('Auto Backup On-Off', 'tf', 'bautobackup', '$backupdb', 'Auto backup Db on or off ?', 'true'),
    array('Auto Hit and Run On-Off', 'tf', 'bautohitrun', '$autohitrun', 'Auto Hit and Run System on or off ?', 'true'),
    'Paths',
    ...
    array('Lottery Interval', 'sec', 'talottery', '$autolottery_interval', 'How long between lottery cleanups.', '172800'),
    ...
    array('Auto invite duration ', 'sec', 'tainvited', '$autoinvitetime', 'Days between auto invite running', '86400 * 30'),
...
*/
    ...
    array('UC_DESIGNER', 'string', 'userclass12', 'UC_DESIGNER', 'Define User Classes', '7'),
    array('UC_CODER', 'string', 'userclass13', 'UC_CODER', 'Define User Classes', '8'),
    'User Class Names',
    ...
    array('UC_DESIGNER', 'string', 'duserclass12', 'duserclass12', 'Define User Class Name', 'Designer'),
