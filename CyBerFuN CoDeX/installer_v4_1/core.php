...
define ('TBVERSION', '01-06-08 Installer Beta'); // edit this correctly :p

if (file_exists(ConfigFN)) include_once(ConfigFN);
else {
    $pic_base_url = 'pic/';
    $SITENAME = '::InstallerV1::'; /// edit this :p
}
require_once('include/user_functions.php');
require_once('themes/green/template.php');
require_once('include/vfunc.php');

function stdhead($title = "")
{
    global $BASEURL, $SITENAME, $pic_base_url;
    ...
    $ss_uri = 'themes/green/green.css'; // edit this :p
...
<td class=clear>
<div align=center>
<img src="themes/green/theme/top_main_bg.png" align=center>
</div>
</td>
...
function stdfoot()
{
    ...
    print("<td class=bottom align=left width=49%></td><td width=49% align=right class=bottom></td>\n");
    print("</tr></table>\n");
    print("</body></html>\n");
}
