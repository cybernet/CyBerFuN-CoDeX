...
<?php
        ...
        if (!isset($CURUSER))
            $s .= "(<a href=\"loginproc/index.php?returnto=" . urlencode(substr($_SERVER["REQUEST_URI"], 1)) . "&amp;nowarn=1\">Log in</a> to rate it)";
        else {
...
ORDER BY u.username DESC");
   ...
   /////////////////////////////////////////////////////////
    ...
    <b><font size="2" color="#FF0000">free Leech Torrent</font></b> <small><b>(Only upload stats count!)</b></small></td></tr>' : '');
            ...
            ?>
            <tr><td class="rowhead" valign="top" align="right" width='1%'>Torrent<br/>Reputation</td><td align='left' width='99%'><?php echo $member_reputation?> (counts towards uploaders Reputation)<br />
            </td></tr>
            <?php
            if (get_user_class() >= UC_MODERATOR) {
