...
function get_typ_name($typ)
{
    switch ($typ) {
        ...
        case "autoclean": return "Auto cleanup";
        ...
        case "ratiocheat": return "Possible Ratio Cheat";
        case "topicdelete": return "Topic was deleted";
        case "bonusreset": return "User bonus points reset";
...
$types = array('torrentupload', 'torrentedit', 'torrentdelete', 'promotion', 'demotion', 'addwarn', 'remwarn', 'accenabled', 'accdisabled', 'accdeleted', 'passwordreset', 'ratioedit', 'newmember', 'autoclean', 'slowautoclean', 'autohitrun', 'autobackupdb', 'autooptimizedb', 'autowarn', 'autodewarn', 'autoremvip', 'autoremdon', 'customsmile','staffaction','shoutcom','userdelete','ratiocheat','topicdelete','bonusreset','happyhour');
...
if (isset($_GET["filter"])) {
    ...
    if (mysql_num_rows($res) == 0)
        ...
        while ($arr = mysql_fetch_assoc($res)) {
            ...
            if (strpos($arr['txt'], 'Auto cleanup Complete')) $color = "#ff0000";
            if (strpos($arr['txt'], 'users received seedbonus')) $color = "#ff0000";
            ...
            if (strpos($arr['txt'], 'Possible Ratio Cheat')) $color = "teal"; 
            if (strpos($arr['txt'], 'from User to Power User')) $color = "purple";
            if (strpos($arr['txt'], 'Topic was deleted')) $color = "purple";
            if (strpos($arr['txt'], 'User bonus points reset')) $color = "darkred";
            if (strpos($arr['txt'], 'Happy hour was @')) $color = "pink";
