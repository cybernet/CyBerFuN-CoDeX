...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while ($a = mysql_fetch_assoc($r_list)) {
		...
		<td align="center" nowrap="nowrap" ><a href="forums.php?action=deleteforum&amp;forumid=<?=($a["subid"])?>"><img src="pic/drop.png" title="Delete Forum" style="border:none;padding:2px;" /></a><a href="forums.php?action=editforum&amp;forumid=<?=($a["subid"])?>"><img src="pic/edit.png" title="Edit Forum" style="border:none;padding:2px;" /></a></td>
    </tr>
