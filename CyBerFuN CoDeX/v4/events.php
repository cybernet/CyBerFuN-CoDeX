...
<tr><th>User</th><th>Text</th><th>Start</th><th>End</th><th>Freeleech?</th><th>DUpload?</th><th>Invites?</th><th>Show Dates?</th><th>&nbsp;</th></tr>
<?php
foreach($scheduled_events as $scheduled_event){
...
$invites = (bool)(int)$scheduled_event['invitesEnabled'];

if($freeleech){
$freeleech = "<img src=\"".$pic_base_url."events/on.gif\" alt=\"Freeleech Enabled\" title=\"Enabled\" />";
}else{
$freeleech = "<img src=\"".$pic_base_url."events/off.gif\" alt=\"Freeleech Disabled\" title=\"Disabled\" />";
}
if($doubleUpload){
$doubleUpload = "<img src=\"".$pic_base_url."events/on.gif\" alt=\"Double Upload Enabled\" title=\"Enabled\" />";
}else{
$doubleUpload = "<img src=\"".$pic_base_url."events/off.gif\" alt=\"Double Upload Disabled\" title=\"Disabled\" />";
}

if($invites){
$invites = "<img src=\"".$pic_base_url."events/on.gif\" alt=\"Invites Enabled\" title=\"Enabled\" />";
}else{
$invites = "<img src=\"".$pic_base_url."events/off.gif\" alt=\"Invites Disabled\" title=\"Disabled\" />";
}
$showdates = (bool)(int)$scheduled_event['displayDates'];
if($showdates){
$showdates = "<img src=\"".$pic_base_url."events/on.gif\" alt=\"Showing of Dates Enabled\" title=\"Enabled\" />";
}else{
$showdates = "<img src=\"".$pic_base_url."events/off.gif\" alt=\"Showing of Dates Disabled\" title=\"Disabled\" />";
}

echo "<tr><td align=\"center\">$username[username]</td><td align=\"center\">$text</td><td align=\"center\">$start</td><td align=\"center\">$end</td><td align=\"center\">$freeleech</td><td align=\"center\">$doubleUpload</td><td align=\"center\">$invites</td><td align=\"center\">$showdates</td><td align=\"center\"><input type=\"submit\" name=\"editEvent_$id\" value=\"Edit\" /> <input type=\"submit\" onclick=\"return checkAllGood('$text')\" name=\"removeEvent_$id\" value=\"Remove\" /></td></tr>";
}
?>
...
<tr><th align="right">Invites</th><td><input type="checkbox" name="editInvites" /></td></tr>
...
<tr><th align="right">DoubleUpload</th><td><input type="checkbox" name="editFreeleech" <?php echo $doubleUpload; ?>/></td></tr>
<tr><th align="right">Invites</th><td><input type="checkbox" name="editFreeleech" <?php echo $invites; ?>/></td></tr>
