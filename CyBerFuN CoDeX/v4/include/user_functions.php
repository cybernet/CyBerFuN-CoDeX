...
function write_staff()
	{
		...
		$r = mysql_query("select id,username,class FROM users WHERE class BETWEEN ".STAFF_CLASS." and ".MAX_CLASS." order by class DESC, username ASC") or print(mysql_error());
...
global $duserclass0, $duserclass1, $duserclass2, $duserclass3, $duserclass4, $duserclass5, $duserclass6, $duserclass7, $duserclass8, $duserclass9, $duserclass10, $duserclass11, $duserclass12, $duserclass13;
  switch ($class)
  {
    ...
    case UC_OWNER: return duserclass12;
...
function get_user_class_image($class)
{
  ...
  {    
    ...
    case UC_OWNER: return "pic/class/leader.gif";
...
///////////////Rep system by CoLdFuSIon - tbdev 2009/////////////
	...
	if( $rep_is_on )
		{
			...
			if( $mode === 0 )
			return "Rep: ".$posneg . "<a href='javascript:;' onclick=\"PopUp('$BASEURL/reputation.php?pid={$user['id']}','Reputation',400,241,1,1);\"><img src='./pic/plus.gif' border='0' alt='Add reputation:: {$user['username']}' title='Add reputation:: {$user['username']}' /></a>";
			else
			return "Rep: ".$posneg;
