...
{
    global $pic_base_url, $config, $php_file, $page_find, $lang_off, $language, $CURUSER, $ss_uri, $waiton, $wait1, $wait2, $wait3, $wait4, $oldtorrents, $progress, $cat_ico_uri;
...
<td class="colhead" align="left"><a href="browse.php?<?php echo $oldlink;
    ...
    print("<td class=colhead align=center>Hidden</td>");
    ?>
    <td class="colhead" align="left"><a href="browse.php?<?php echo $oldlink;
    ...
    foreach ($records as $row) {
        ...
        if (($CURUSER['split'] == "yes") && ($_SERVER["REQUEST_URI"] == "/browse.php") && !isset($_GET["page"])) {
           ...
           // ////End Sticky only highlight/////////////////
            ...
            //echo("<a href=\"browse.php?cat=" . $cat["id"] . "\"><img border=\"0\" src=\"/pic/caticons/$cat_ico_uri/{$cat["image"]}\" alt=\"{$cat['name']}\" />");
            ...
            // ////
            // ///////////////////////////////////////////////////
            // == uncomment to use pretimes on browse
            /*
            if ($row['afterpre'] == 'N/A') {
                $preres = "N/A";
            ...
            */          
            ...
            /////////////////subtitles
            $movie_cat = array("3","5","6","9","10","11"); //add here your movie category
            ...
            $hiddentorrent = $hiddenrow["hidden"];
            $staffonly = $hiddenrow["staffonly"];
            if (get_user_class() >= UC_MODERATOR){
            if ($staffonly == "yes")
            print("<td align=center><font color=yellow>Staff<br>Only</font></td>");
            else    
            print("<td align=center>" . $hiddenrow["hidden"] . "</td>");
            }
            else
            print("<td align=center>" . $hiddenrow["hidden"] . "</td>");
            }
            ...
            if ($row["seeders"]) {
                if ($variant == "index") {
                    ...
                    echo("<td align=right><b><a href=details.php?id=$id&amp;hit=1&amp;toseeders=1><font color=" .
