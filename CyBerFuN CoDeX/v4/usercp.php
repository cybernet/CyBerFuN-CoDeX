...
if ($action == "avatar") {
    ...
    if (get_user_class() >= UC_VIP)
        tr("".$language['title']."", "<input size=50 value=\"" . htmlspecialchars($CURUSER["title"]) . "\" name=title /><br/>", 1);
    */
    tr("".$language['avaurl']."", "<input name=avatar size=50 value=\"" . htmlspecialchars($CURUSER["avatar"]) . "\" /><br/><br/>\n".$language['avaurl1']."".$language['avaurl2']."", 1);
