...
*You may edit this stylesheet and all associated files to fit your site requirements.
*=====================================================================================
*/
 ...
 */
 ...
 img, div, input, td, a, table { behavior: url("themes/aoi/iefix/iepngfix.htc") }
...
<!--LINKS-->
<table align="center" background="themes/aoi/images/header.jpg" width="912" height="76">
	<td>&nbsp;
		<table align="center" border="0" cellspacing="0" cellpadding="0" style="background:transparent">
          <?php if ( !$CURUSER ) {
    ...
    ?>
          <center>
            ...
            <td align="center" class="up_link"><a href=index.php id=home>Home</a></td>
            <td align="center" class="up_link"><a href=browse.php id=browse>Browse</a></td>
            <td align="center" class="up_link"><a href=chat.php id=irc>Irc</a></td>
            <?php
    echo "<td align=center class=up_link>" . ( $CURUSER['show_shout'] === 'no' ? "<a class=normal href=shoutbox.php?show_shout=1&show=yes id=chat>Chat on</a>" : "<a class=normal href=shoutbox.php?show_shout=1&show=no id=chat>Chat off</a>" ) . " </td>";

    ?>
            <td align="center" class="up_link"><a href=requests.php id=request>Request</a></td>
            <td align="center" class="up_link"><a href=viewoffers.php id=offer>Offer</a></td>
            <td align="center" class="up_link"><a href=upload.php id=upload>Upload</a></td>
            <td align="center" class="up_link"><a href=usercp.php id=profile>Profile</a></td>
            <td align="center" class="up_link"><a href=forums.php id=forum>Forum</a></td>
            <td align="center" class="up_link"><a href=staff.php id=staff>Staff</a></td>
...
<!--LOGO-->
<table align=center border="0" background="themes/aoi/images/logo.gif" width=912 height="152">
  <td>
  </td>
</table>
<!--STATUSBAR-->
<table align=center border="0" background="themes/aoi/images/status.jpg" width=912 height="76" style="background-repeat:no-repeat">
  <td>
...
?>
    ...
    ?>
      <table align="center">
        <tr>
          <td class="statusbar">
          	<table width="730" style="color:#00bfff;">
              <tr>
...
<a href="logout.php" onClick="return log_out()"><img src="themes/default/pic/logout.png" border="0" title="Go out and play"/></a>
    ...
    if ( isset( $returnto ) )
        echo( "<input type=\"hidden\" name=\"returnto\" value=\"" . safeChar( $returnto ) . "\" />\n" );
...
<table width=100"%" cellspacing=0 cellpadding=0 style='background: transparent'>
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" style='background: transparent; color:deepskyblue'>
    <tr>
      <td class="left_side"></td>
      <td class='cHs' align=center width=869 class="interior" valign=top>
<?php
...
if ( $comment ) {
    echo( "<table border=0 cellspacing=10 cellpadding=10 ><tr><td style=\"padding: 10px;background:lightgreen\">\n" );
...
<table width=760 border=1 cellspacing=0 cellpadding="5" style="margin:10px">
  <tr>
    <td class="colhead"><b>Announcement: <?php echo( safe( $ann_subject ) );

    ?></b></td>
  </tr>
  <tr>
    <td style="padding: 10px;background:#cccccc;color:#666666"><?php echo( format_comment( $ann_body ) );
...
<table width='758' border='0' cellspacing='0' cellpadding='1' style="margin:10px">
  <tr>
  ...
  <br />
	...
	<p><a href='shoutbox.php' target='sbox'>[ Refresh ]</a><a href="javascript:PopMoreSmiles('shbox','shbox_text')">[ More Smilies ]</p>
                                 <? 
