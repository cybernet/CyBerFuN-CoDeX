...
{
	private $_dir,
			$_modes = array('owner' => 0 , 'group' => 0 , 'public' => 0);
	...
	{
		return (is_dir($dir) ? array('chmod', @chmod($dir, $this->getMode()), $this->getMode(), $dir) : array('mkdir', @mkdir($dir, $this->getMode()), $this->getMode(), $dir));
	}
