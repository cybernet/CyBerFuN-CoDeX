...
<tr>
<td colspan="3" class="cHs2" width="838" height="145" background="pic/logo5.png"></td>
</tr>
<tr>
<td colspan="3" class="cHs2" height="27" background="pic/menu.gif"><table class="clear" background="pic/backcen.gif" width:="834" margin-top:="0" align="center" border="0" cellspacing="8" cellpadding="2">
<?php if (!$CURUSER) {
    ?>
<?php } else {
    ?>
...
if ($CURUSER) {
    ...
    if ($CURUSER['donor'] == "yes")
        $icon .= "<img src=\"themes/large/pic/donor.png\" align=\"baseline\"alt=donor title=donor $icon_style />";
    if ($CURUSER['warned'] == "yes")
        $icon .= "<img src=\"themes/large/pic/warned.png\" align=\"baseline\"  alt=warned title=warned $icon_style />";
    if ($CURUSER["webseeder"] == "yes")
        $icon .= "<img src=\"themes/large/pic/webseeder.png\" align=\"baseline\"  alt=webseeder title=webseeder $icon_style/>";
...
<b>
 ...
 <b><?php echo $language['slots'];?><a href="#"><?=number_format($CURUSER['freeslots'])?></a></b>&nbsp;|
 ...
 <?php }
    ?>
 <br /><?php echo $language['ratio'];?><?=$ratio?> |&nbsp;<font style="color:#006600">U:</font> <?=$uped?> <font style="color:#990000">D:</font> <?=$downed?> | <img src="pic/arrowdown.gif" width="9" height="11" alt="downloding torrents" title="downloding torrents"/><?=$activeleech?>&nbsp;<img src="pic/arrowup.gif" width="9" height="11" alt="seeding torrents" title="seeding torrents" /><?=$activeseed?> |</b>
...
<a href='usermood.php' onclick="return popitup('usermood.php')"><span class='tool'><img src='<?php echo $pic_base_url;
    ?>smilies/<?php echo $moodpic;
    ?>' alt='' style="float:left; margin-top: 1px" border='0' /><span class='tip'> <?php echo $CURUSER['username'];
    ?> <?php echo $moodname;
    ?>!</span></span></a></td>
...
if (!empty($unread))
    ...
    echo $inbox;
?>
		<a href="#" onclick="themes();"><img src="themes/large/pic/theme.png" width="16" height="16" alt=" " title="Change your theme" border="0"/></a>
		<a href="bookmarks.php"><img src="themes/large/pic/bookmarks.png" width="16" height="16" alt=" " title="Bookmarked torrents" border="0"/></a>&nbsp;
<a href="friends.php"><img style="border:none" alt="Buddylist" title="Buddylist" src="themes/large/pic/friends.png" width="16" height="16" /></a>&nbsp;
<a href="rss.php?userid=<?=$CURUSER["id"]?>"><img src="themes/large/pic/rss.png" border="0" title="RSS"/></a>&nbsp;
<a href="logout.php" onClick="return log_out()"><img src="themes/large/pic/logout.png" border="0" title="Go out and play"/></a>
</td>
</tr>
</table>
</div>
