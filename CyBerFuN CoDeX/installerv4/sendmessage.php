...
$SITENAME
EOD;
        @mail($arr_receiver['email'], "You have received a PM from " . $username . "!",
...
if ($CURUSER["sendpmpos"] == 'no') {
    stdmsg("Sorry...", "You are not authorized to send any Private Messages - Please contact site Admin.)");
    stdfoot();
    exit;
}
